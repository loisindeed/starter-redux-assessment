...
const options = {
  ...
  reducers: {
    ...
    addPhoto: (state, action) => {
        state.photos.unshift({ // unshift for adding to the top
...
export const selectFilteredPhotos = (state) => { // need it to search the caption
    ...
    return photos.filter((item) => // use the caption
